...
def train_model(train_file, val_file, test_file, model_dir, output_dir, batch_size=8, epochs=10):
...
train_file = "data_preprocess/500rib_train_s_modified.csv"
val_file = "data_preprocess/500rib_val_s_modified.csv"
test_file = "data_preprocess/500rib_test_s_modified.csv"
model_dir = "LookingGlass-2"  # Directory where your base model is saved
output_dir = "finetune_model_chunks"  # Directory to save fine-tuned model and checkpoints
